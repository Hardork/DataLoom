...
import com.hwq.dataloom.core.workflow.edge.RunCondition;
...
public class Graph {
    ...
    public static Graph init(String graphConfig, String rootNodeId) {
        ...
        // init answer stream generate routes (初始化响应流生成路由)
     ...
     */
    private static void checkExceedParallelLimit(Map<String, GraphParallel> parallelMapping, int levelLimit, String parentParallelId, int currentLevel) {
     ...
     */
    public static void checkCircle(List<String> route, Map<String, List<GraphEdge>> sourceEdgeMapping) {
    ...
    private static void recursivelyAddParallelNodeIds(
     ...
     * @return 是否存在路径节点中
     */
    private static boolean isNodeInRoutes(
            Map<String, List<GraphEdge>> reverseEdgeMapping,
            String startNodeId,
     ...
     */
    private static void recursivelyFetchRoutes(
            Map<String, List<GraphEdge>> edgeMapping,
            String startNodeId,
