...
/**
 * @author HWQ
 * @date 2024/9/22 00:39
 * @description
 */
@Component
@Slf4j
@ServerEndpoint("/websocket/chart/{userId}")  // 接口路径 ws://localhost:8081/webSocket/userId;
public class ChartAnalysisWebSocket {
    ...
    //  注：底下WebSocket是当前类名
    private static CopyOnWriteArraySet<ChartAnalysisWebSocket> webSockets =new CopyOnWriteArraySet<>();
    // 用来存在线连接用户信息
