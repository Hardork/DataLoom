package com.hwq.dataloom.product.redis;
...
public class RedisService implements IRedisService{
    ...
    public <T> void setValue(String key, T value, long expired) {
        redissonClient.<T>getBucket(key).set(value,Duration.ofSeconds(expired));
    }
    ...
    @Override
    public Boolean addSet(String key, Set<Long> skuList) {
        return redissonClient.getSet(key).addAll(skuList);
    }
    ...
    @Override
    public Boolean removeSetElement(String key, Long sku) {
        return redissonClient.getSet(key).remove(sku);
    }
